...
pub struct CallCodeEvent {
    pub r#type: serde_json::Value,
    pub code: gemini_live_wire::prelude::ExecutableCode,
}
...
pub struct CodeResultEvent {
    pub r#type: serde_json::Value,
    pub result: gemini_live_wire::prelude::CodeExecutionResult,
}
...
pub struct Example {
    ...
    pub input: gemini_live_wire::prelude::Content,
    /// The expected output content for the example.
    pub output: Vec<gemini_live_wire::prelude::Content>,
}
...
pub struct ExecutorContext {
    ...
    pub user_content: gemini_live_wire::prelude::Content,
...
pub struct InvocationContextParams {
    ...
    pub branch: Option<String>,
    pub agent: Arc<dyn Agent>,
    pub user_content: Option<gemini_live_wire::prelude::Content>,
    pub session: serde_json::Value,
...
pub struct LiveRequest {
    ...
    pub content: Option<gemini_live_wire::prelude::Content>,
    /// If set, send the blob to the model in realtime mode.
    pub blob: Option<gemini_live_wire::prelude::Blob>,
    /// If set, signal the start of user activity to the model.
    pub activity_start: Option<gemini_live_wire::prelude::ActivityStart>,
    /// If set, signal the end of user activity to the model.
    pub activity_end: Option<gemini_live_wire::prelude::ActivityEnd>,
...
pub struct LlmRequest {
    ...
    pub contents: Vec<gemini_live_wire::prelude::Content>,
...
pub struct LlmResponse {
    ...
    pub grounding_metadata: Option<gemini_live_wire::prelude::GroundingMetadata>,
    ...
    pub live_session_resumption_update: Option<gemini_live_wire::prelude::SessionResumptionUpdatePayload>,
    /// Audio transcription of user input.
    pub input_transcription: Option<gemini_live_wire::prelude::TranscriptionPayload>,
    /// Audio transcription of model output.
    pub output_transcription: Option<gemini_live_wire::prelude::TranscriptionPayload>,
}
...
pub struct MemoryEntry {
    ...
    pub content: gemini_live_wire::prelude::Content,
...
pub struct RunConfig {
    ...
    pub speech_config: Option<gemini_live_wire::prelude::SpeechConfig>,
    /// The output modalities. If not set, it's default to AUDIO.
    pub response_modalities: Option<Vec<gemini_live_wire::prelude::Modality>>,
    ...
    pub proactivity: Option<gemini_live_wire::prelude::ProactivityConfig>,
    /// Realtime input config for live agents with audio input from user.
    pub realtime_input_config: Option<gemini_live_wire::prelude::RealtimeInputConfig>,
...
pub struct SaveArtifactRequest {
    ...
    pub artifact: gemini_live_wire::prelude::Part,
...
pub struct ToolCallEvent {
    pub r#type: serde_json::Value,
    pub call: gemini_live_wire::prelude::FunctionCall,
}
...
pub struct ToolResultEvent {
    pub r#type: serde_json::Value,
    pub result: gemini_live_wire::prelude::FunctionResponse,
}
...
pub struct TraceSendDataParams {
    ...
    pub data: Vec<gemini_live_wire::prelude::Content>,
}
...
pub struct TranscriptionEntry {
    ...
    pub data: gemini_live_wire::prelude::Blob,
}
