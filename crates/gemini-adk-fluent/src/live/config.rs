...
use gemini_adk::live::{ResultFormatter, ToolExecutionMode};
...
impl Live {
    ...
    pub fn agent_tool(
        ...
        agent: impl gemini_adk::text::TextAgent + 'static,
    ) -> Self {
    ...
    pub fn agent_tool_arc(
        ...
        name: impl Into<String>,
        description: impl Into<String>,
        agent: Arc<dyn gemini_adk::text::TextAgent>,
    ) -> Self {
        self.deferred_agent_tools.push(DeferredAgentTool {
            name: name.into(),
            description: description.into(),
    ...
    pub fn tool_background_with_scheduling(
        mut self,
        tool_name: impl Into<String>,
        scheduling: gemini_live::prelude::FunctionResponseScheduling,
    ) -> Self {
        self.tool_execution_modes.insert(
            tool_name.into(),
            ToolExecutionMode::Background {
