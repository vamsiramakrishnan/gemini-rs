...
impl AgentHarness {
    ...
    pub fn state(&self) -> &gemini_adk::State {
        &self.state
    }
    ...
    pub async fn run(
        &self,
        agent: &dyn gemini_adk::text::TextAgent,
    ) -> Result<String, gemini_adk::error::AgentError> {
