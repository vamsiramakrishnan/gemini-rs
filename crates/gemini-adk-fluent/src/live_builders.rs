...
impl PhaseDefaults {
    ...
    /// Append a declarative [`gemini_adk::live::context_builder::ContextBuilder`] to every phase's instruction.
    ///
    ...
    /// ))
    /// ```
    pub fn context(mut self, ctx: gemini_adk::live::context_builder::ContextBuilder) -> Self {
...
impl PhaseBuilder {
    ...
    /// The [`ContextBuilder`](gemini_adk::live::context_builder::ContextBuilder)
    ...
    /// Append a declarative [`gemini_adk::live::context_builder::ContextBuilder`] to this phase's instruction.
    pub fn context(mut self, ctx: gemini_adk::live::context_builder::ContextBuilder) -> Self {
        self.modifiers.push(ctx.into_modifier());
        self
    }
