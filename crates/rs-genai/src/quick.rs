...
//!
//! ```rust,no_run
//! # async fn example() -> Result<(), rs_genai::session::SessionError> {
//! use rs_genai::prelude::*;
//!
//! let session = rs_genai::quick_connect("API_KEY", "gemini-2.0-flash-live-001").await?;
...
//! use rs_genai::prelude::*;
//!
//! let session = rs_genai::quick_connect_vertex(
//!     "ya29.ACCESS_TOKEN",
//!     "my-project",
//!     "us-central1",
