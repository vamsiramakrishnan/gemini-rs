...
//!
//! Run with: `cargo bench -p rs-genai`

use criterion::{black_box, criterion_group, criterion_main, BenchmarkId, Criterion, Throughput};

use rs_genai::buffer::{AudioJitterBuffer, JitterConfig, SpscRing};
use rs_genai::protocol::types::{GeminiModel, SessionConfig, Voice};
use rs_genai::session::SessionCommand;
use rs_genai::transport::{Codec, JsonCodec};
