...
pub struct PhaseBuilder {
    ...
    guard: Option<gemini_adk_rs::StatePredicate>,
    on_enter: Option<gemini_adk_rs::live::SessionHook>,
    on_exit: Option<gemini_adk_rs::live::SessionHook>,
...
impl PhaseBuilder {
    ...
    /// The [`ContextBuilder`](gemini_adk_rs::live::context_builder::ContextBuilder)
