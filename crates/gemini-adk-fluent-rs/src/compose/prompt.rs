...
impl P {
    ...
    ) -> gemini_adk_rs::live::InstructionModifier {
        gemini_adk_rs::live::InstructionModifier::Conditional {
    ...
    pub fn context_fn(
        ...
        gemini_adk_rs::live::InstructionModifier::CustomAppend(std::sync::Arc::new(f))
    }
}
