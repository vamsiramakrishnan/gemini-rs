...
//!
//! ```rust,no_run
//! # async fn example() -> Result<(), gemini_live::session::SessionError> {
//! use gemini_live::prelude::*;
//!
//! let session = gemini_live::quick_connect("API_KEY", "gemini-2.0-flash-live-001").await?;
...
//! use gemini_live::prelude::*;
//!
//! let session = gemini_live::quick_connect_vertex(
//!     "ya29.ACCESS_TOKEN",
//!     "my-project",
//!     "us-central1",
