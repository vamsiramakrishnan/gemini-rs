//! Runtime agent example — using gemini-adk.
//!
...
use gemini_adk::context::InvocationContext;
use gemini_adk::error::AgentError;
use gemini_adk::router::AgentRegistry;
...
impl Agent for WeatherAgent {
    ...
    fn tools(&self) -> Vec<gemini_live::prelude::Tool> {
