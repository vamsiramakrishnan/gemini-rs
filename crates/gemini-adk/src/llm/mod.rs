...
use gemini_live::prelude::{Content, Part, Tool};
    ...
    pub fn from_text(text: impl Into<String>) -> Self {
        Self {
            contents: vec![Content {
                role: Some(gemini_live::prelude::Role::User),
...
impl LlmResponse {
    ...
    pub fn function_calls(&self) -> Vec<&gemini_live::prelude::FunctionCall> {
        self.content
            .parts
            .iter()
            .filter_map(|p| match p {
        ...
        let resp = LlmResponse {
            content: Content {
                ...
                parts: vec![Part::FunctionCall {
                    function_call: gemini_live::prelude::FunctionCall {
