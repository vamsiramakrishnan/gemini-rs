...
//! L0 [`gemini_live::telemetry::TelemetryConfig`] tailored for agent applications.
//!
//! # Feature flags
//!
...
///
/// ```rust,no_run
/// use gemini_adk::telemetry::setup::TelemetrySetup;
///
...
impl TelemetrySetup {
    ...
    pub fn init(self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        {
            let config = gemini_live::telemetry::TelemetryConfig {
