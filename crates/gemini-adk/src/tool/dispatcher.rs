...
use gemini_live::prelude::{FunctionCall, FunctionDeclaration, FunctionResponse, Tool};
...
impl ToolDispatcher {
    ...
    ///
    /// ```rust,ignore
    /// use gemini_adk::tool::{ToolDispatcher, SimpleTool};
    /// use serde_json::json;
    ///
...
impl gemini_live::prelude::ToolProvider for ToolDispatcher {
    fn declarations(&self) -> Vec<gemini_live::prelude::Tool> {
