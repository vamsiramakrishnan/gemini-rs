//! Runtime agent example — using gemini-adk-rs.
//!
...
use gemini_adk_rs::context::InvocationContext;
use gemini_adk_rs::error::AgentError;
use gemini_adk_rs::router::AgentRegistry;
...
impl Agent for WeatherAgent {
    ...
    fn tools(&self) -> Vec<gemini_genai_rs::prelude::Tool> {
