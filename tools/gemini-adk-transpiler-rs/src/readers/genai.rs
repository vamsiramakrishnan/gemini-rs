...
fn wire_type_map() -> HashMap<&'static str, &'static str> {
    ...
    // Content & Parts
    m.insert("Content", "gemini_genai_rs::prelude::Content");
    m.insert("Part", "gemini_genai_rs::prelude::Part");
    m.insert("Blob", "gemini_genai_rs::prelude::Blob");
    m.insert("FileData", "gemini_genai_rs::prelude::FileData");
    m.insert("ExecutableCode", "gemini_genai_rs::prelude::ExecutableCode");
    m.insert(
        "CodeExecutionResult",
    ...
    m.insert("Tool", "gemini_genai_rs::prelude::Tool");
    m.insert("ToolConfig", "gemini_genai_rs::prelude::ToolConfig");
    m.insert(
        "FunctionCallingConfig",
        "gemini_genai_rs::prelude::FunctionCallingConfig",
    );
    ...
    m.insert(
        "PrebuiltVoiceConfig",
        "gemini_genai_rs::prelude::PrebuiltVoiceConfig",
    );
    m.insert("ThinkingConfig", "gemini_genai_rs::prelude::ThinkingConfig");
    m.insert(
        "RealtimeInputConfig",
        "gemini_genai_rs::prelude::RealtimeInputConfig",
    );
    m.insert(
        "AutomaticActivityDetection",
        "gemini_genai_rs::prelude::AutomaticActivityDetection",
    );
    m.insert(
        "SessionResumptionConfig",
        "gemini_genai_rs::prelude::SessionResumptionConfig",
    );
    m.insert(
        "ContextWindowCompressionConfig",
        "gemini_genai_rs::prelude::ContextWindowCompressionConfig",
    );
    m.insert("SlidingWindow", "gemini_genai_rs::prelude::SlidingWindow");
    m.insert(
        "ProactivityConfig",
        "gemini_genai_rs::prelude::ProactivityConfig",
    );
    m.insert(
        "InputAudioTranscription",
        "gemini_genai_rs::prelude::InputAudioTranscription",
    );
    m.insert(
        "OutputAudioTranscription",
        "gemini_genai_rs::prelude::OutputAudioTranscription",
    );

    // Metadata
    m.insert("UsageMetadata", "gemini_genai_rs::prelude::UsageMetadata");
    m.insert(
        "GroundingMetadata",
        "gemini_genai_rs::prelude::GroundingMetadata",
    );
    m.insert(
        "UrlContextMetadata",
        "gemini_genai_rs::prelude::UrlContextMetadata",
    );
...
mod tests {
    ...
    fn map_alias_with_wire_type() {
        ...
        assert_eq!(result, "gemini_genai_rs::prelude::Content");
    }
    ...
    fn build_lookup_from_schema() {
        let schema = GenaiSchema {
            ...
            types: vec![GenaiTypeDef {
                ...
                fields: vec![],
                extends: None,
                wire_type: Some("gemini_genai_rs::prelude::Content".to_string()),
        ...
        assert_eq!(
            lookup.get("Content"),
            Some(&"gemini_genai_rs::prelude::Content".to_string())
        );
    }
}
