...
const NON_DEFAULT_WIRE_TYPES: &[&str] = &[
    ...
    "gemini_genai_rs::prelude::Part",
    "gemini_genai_rs::prelude::Blob",
    "gemini_genai_rs::prelude::FunctionCall",
    "gemini_genai_rs::prelude::FunctionResponse",
    "gemini_genai_rs::prelude::FunctionDeclaration",
    "gemini_genai_rs::prelude::ExecutableCode",
    "gemini_genai_rs::prelude::CodeExecutionResult",
    "gemini_genai_rs::prelude::Tool",
    "gemini_genai_rs::prelude::ToolConfig",
    "gemini_genai_rs::prelude::FileData",
];
...
pub fn generate(schema: &AdkSchema) -> String {
    ...
    // File header
    out.push_str("// AUTO-GENERATED by gemini-adk-transpiler-rs -- do not edit manually\n");
    ...
    out.push_str("// Replace these with actual imports from gemini-adk-rs.\n\n");
...
// ---------------------------------------------------------------------------
// Compilable codegen — produces code that compiles against gemini-adk-rs
// ---------------------------------------------------------------------------

/// Resolve a phantom Rust type to a real type from `gemini-adk-rs`.
///
/// Resolution order:
...
fn resolve_runtime_type(rust_type: &str) -> String {
    ...
    match rust_type {
        "Content" => return "gemini_genai_rs::prelude::Content".to_string(),
        "Part" => return "gemini_genai_rs::prelude::Part".to_string(),
        ...
        "Modality" => return "gemini_genai_rs::prelude::Modality".to_string(),
...
/// Generate Rust source code that compiles against `gemini-adk-rs`.
///
...
pub fn generate_compilable(schema: &AdkSchema) -> String {
    ...
    // Imports — uses `crate::` because the generated file lives inside gemini-adk-rs.
    out.push_str("use std::sync::Arc;\n");
    out.push_str("use async_trait::async_trait;\n");
...
mod tests {
    ...
    fn codegen_header_contains_source_info() {
        ...
        assert!(code.contains("AUTO-GENERATED by gemini-adk-transpiler-rs"));
    ...
    fn compilable_uses_real_imports() {
        ...
        assert!(
            ...
            "Should import from crate (inside gemini-adk-rs)"
        );
        assert!(
