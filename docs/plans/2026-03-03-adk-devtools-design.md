...
```
┌─────────────────────────────────────────────────────┐
│  tools/gemini-adk-cli-rs/                (Binary crate)       │
...
│  Depends on: gemini-adk-fluent-rs (L2)                     │
└─────────────────────────────────────────────────────┘
```
...
| `gemini-adk-cli-rs` binary (`adk web`, `adk run`) | P0 |
...
The Web UI (`apps/gemini-adk-web-rs/`) continues to exist as example apps. It is NOT replaced. Instead:
