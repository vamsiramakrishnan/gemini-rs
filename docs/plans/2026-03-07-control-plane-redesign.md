...
**Date**: 2026-03-07
**Scope**: L0 (gemini-genai-rs), L1 (gemini-adk-rs), L2 (gemini-adk-fluent-rs)
...
|-------|--------|---------------------|
| **0.1** GenerationComplete event | Done | `gemini-genai-rs/src/session/mod.rs`, `gemini-genai-rs/src/transport/connection.rs` |
...
| **2** Generation Complete extractors | Done | `gemini-adk-rs/src/live/extractor.rs`, `gemini-adk-rs/src/live/transcript.rs`, `gemini-adk-rs/src/live/processor.rs` |
| **3** Soft Turn Detection | Done | `gemini-adk-rs/src/live/soft_turn.rs` (new), `gemini-adk-rs/src/live/processor.rs`, `gemini-adk-rs/src/live/builder.rs`, `gemini-adk-fluent-rs/src/live.rs` |
| **4** Context Injection Steering | Done | `gemini-adk-rs/src/live/steering.rs` (new), `gemini-adk-rs/src/live/processor.rs`, `gemini-adk-rs/src/live/builder.rs`, `gemini-adk-fluent-rs/src/live.rs` |
| **5** Tool Availability Advisory | Done | `gemini-adk-rs/src/live/processor.rs`, `gemini-adk-rs/src/live/builder.rs`, `gemini-adk-fluent-rs/src/live.rs` |
| **6** Conversation Repair Protocol | Done | `gemini-adk-rs/src/live/needs.rs` (new), `gemini-adk-rs/src/live/processor.rs`, `gemini-adk-rs/src/live/builder.rs`, `gemini-adk-fluent-rs/src/live.rs` |
| **7** Session Persistence | Done | `gemini-adk-rs/src/live/persistence.rs` (new), `gemini-adk-rs/src/state.rs`, `gemini-adk-rs/src/live/processor.rs`, `gemini-adk-rs/src/live/builder.rs`, `gemini-adk-fluent-rs/src/live.rs` |
...
## Phase 0: Protocol Surface (L0 — gemini-genai-rs)
...
**File**: `crates/gemini-genai-rs/src/session/mod.rs`
...
**File**: `crates/gemini-genai-rs/src/transport/connection.rs` (~line 403)
...
**File**: `crates/gemini-genai-rs/src/protocol/messages.rs`
...
**File**: `crates/gemini-genai-rs/src/transport/connection.rs`
...
**New file**: `crates/gemini-adk-rs/src/live/context_horizon.rs`
...
**File**: `crates/gemini-adk-rs/src/live/extractor.rs`
...
**File**: `crates/gemini-adk-rs/src/live/processor.rs`
...
**File**: `crates/gemini-adk-rs/src/live/transcript.rs`
...
**File**: `crates/gemini-adk-rs/src/live/phase.rs`
...
**File**: `crates/gemini-adk-rs/src/live/needs.rs` (new)
...
**File**: `crates/gemini-adk-rs/src/live/persistence.rs` (new)
