...
Enhance `TelemetryConfig::init()` in `gemini-genai-rs/src/telemetry/mod.rs` to
...
|---|---|---|
| `gemini_genai_rs.session` | `gemini_genai_rs.session` | `session.id` |
| `gemini_genai_rs.connect` | `gemini_genai_rs.connect` | `net.peer.name` |
| `gemini_genai_rs.tool_call` | `gemini_genai_rs.tool_call` | `rpc.method` |
...
| File | Workstream |
|------|-----------|
| `apps/gemini-adk-web-rs/static/worklets/capture-processor.js` | A |
| `apps/gemini-adk-web-rs/static/worklets/playback-processor.js` | A |

### Modified Files

| File | Workstream | Changes |
|------|-----------|---------|
| `apps/gemini-adk-web-rs/static/audio.js` | A | Rewrite: AudioWorklet + fallback |
| `apps/gemini-adk-web-rs/static/devtools.js` | C | Remove telemetry tab, add status bar |
| `apps/gemini-adk-web-rs/static/devtools.css` | C | Remove telemetry styles, add status bar styles |
| `apps/gemini-adk-web-rs/static/app.html` | C | Add status bar container |
| `crates/gemini-genai-rs/Cargo.toml` | B | Add optional otel dependencies |
| `crates/gemini-genai-rs/src/telemetry/mod.rs` | B | OTel layer init in TelemetryConfig |
| `crates/gemini-adk-rs/Cargo.toml` | B | Forward otel feature flag |
